...
describe('saveQuestion', () => {
    ...
    it('will return saved question and all expected fields are populated when correctly formatted data is passed', async () => {
        ...
        const result = await saveQuestion({ optionOneText: 'Option 1', optionTwoText: 'Option 2', author: 'sarahedo' });
    ...
    it('will return an error if incorrect data is passed to the function', async () => {
        ...
        await expect(saveQuestion(incorrectQuestion)).rejects.toEqual('Please provide optionOneText, optionTwoText, and author');
    });
})
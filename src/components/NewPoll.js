        ...
        <div className="w3-large" style={{ height: 'calc(100vh - 221px)' }}>
            <div className="w3-container w3-padding-64">
                <h2 className="w3-center w3-padding-64">
                    <span className="w3-bottombar w3-border-dark-grey w3-padding-16">Would You Rather</span>
                </h2>
                ...
                <form className="w3-container" onSubmit={handleSubmit}>
                    ...
                    <div className="w3-center">
                        <button type="submit" className="w3-button w3-black" disabled={poll.optionOneText === '' || poll.optionTwoText === ''}>Submit</button>
                    </div>
                </form>
            </div>
        </div>
